...
public class ManageOrderActivity extends AppCompatActivity {
    ...
    private static String urlHostName = "http://192.168.0.105/burgerphp/SelectItemDetails.php";
    private static String urlHostDelete = "http://192.168.0.105/burgerphp/delete.php";
    private static String urlHostBurger = "http://192.168.0.105/burgerphp/selectBurger.php";
    private static String urlHostQty = "http://192.168.0.105/burgerphp/selectQty.php";
    private static String urlHostID = "http://192.168.0.105/burgerphp/selectid.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ManageOrderActivity.this, "Nothing Selected", Toast.LENGTH_SHORT).show();
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                alert_confirm.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        Intent intent = new Intent(ManageOrderActivity.this, EditOrderActivity.class);
                        intent.putExtra(EditOrderActivity.FULLNAME, name);
                        intent.putExtra(EditOrderActivity.BURGER, burg);
                        intent.putExtra(EditOrderActivity.QTY, qty);
                        intent.putExtra(EditOrderActivity.ID, aydi);
    ...
    private class uploadDataToURL extends AsyncTask<String, String, String> {
        ...
        int nPostValueIndex;
        ProgressDialog pDialog = new ProgressDialog(ManageOrderActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            pDialog.dismiss();
            String isEmpty = "";
            android.app.AlertDialog.Builder alert = new AlertDialog.Builder(ManageOrderActivity.this);
            if (s != null) {
                ...
                adapter_name = new ArrayAdapter<String>(ManageOrderActivity.this, android.R.layout.simple_list_item_1, list_name);
    ...
    private class Burg extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String Gender) {
            ...
            if (Gender != null) {
                ...
                adapter_burg = new ArrayAdapter<String>(ManageOrderActivity.this, android.R.layout.simple_list_item_1, list_burg);
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet Connection");
                alert.setTitle("Error");
                alert.show();
    ...
    private class Qty extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String CS) {
            ...
            if (CS != null) {
                ...
                adapter_qty = new ArrayAdapter<String>(ManageOrderActivity.this, android.R.layout.simple_list_item_1, list_qty);
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet Connection");
                alert.setTitle("Error");
                alert.show();
    ...
    private class ID extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String aydi) {
            ...
            if (aydi != null) {
                ...
                Toast.makeText(ManageOrderActivity.this, "Data selected", Toast.LENGTH_SHORT);
                String AYDI = aydi;
                String str = AYDI;
                final String ayds[] = str.split("-");
                list_ID = new ArrayList<String>(Arrays.asList(ayds));
                adapter_ID = new ArrayAdapter<String>(ManageOrderActivity.this, android.R.layout.simple_list_item_1, list_ID);
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet Connection");
                alert.setTitle("Error");
                alert.show();
    ...
    private class delete extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String del) {
            ...
            if (aydi != null) {
                ...
                Toast.makeText(ManageOrderActivity.this, "Data Deleted", Toast.LENGTH_SHORT);
            } else {
                alert.setMessage("Query Interrupted... \nPlease Check Internet Connection");
                alert.setTitle("Error");
                alert.show();
